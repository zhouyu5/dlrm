...
DAYS = 23
LABEL_NAME = 'is_installed,is_clicked,f_0'
INT_FEATURE_COUNT = 47
CAT_FEATURE_COUNT = 30
NUM_EMBEDDINGS_PER_FEAT = '136,5,633,6,5167,6,7,3,24,26,329,19,5801,10,49,901,19,55,34,24,4,4,3,2,2,2,2,3,3,4'

IS_DISCRETIZE = False
DISCRETIZE_BIN = 10
if IS_DISCRETIZE:
    CAT_FEATURE_COUNT += 38
    NUM_EMBEDDINGS_PER_FEAT += f',{DISCRETIZE_BIN}' * 38

IS_INSTALL_TREE_LEAF = True
INSTALL_TREE_NUM = 50
if IS_INSTALL_TREE_LEAF:
    CAT_FEATURE_COUNT += INSTALL_TREE_NUM
    NUM_EMBEDDINGS_PER_FEAT += ',64' * INSTALL_TREE_NUM

IS_CLICK_TREE_LEAF = False
CLICK_TREE_NUM = 50
if IS_CLICK_TREE_LEAF:
    CAT_FEATURE_COUNT += CLICK_TREE_NUM
    NUM_EMBEDDINGS_PER_FEAT += ',64' * CLICK_TREE_NUM
