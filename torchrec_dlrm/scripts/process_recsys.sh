...
date
python data/npy_preproc_recsys.py --input_dir "$raw_tsv_criteo_files_dir" --output_dir "$step_1_output_dir" || exit
...
date
python data/contiguous_preproc_recsys.py --input_dir "$step_1_output_dir" --output_dir "$step_2_output_dir" --frequency_threshold 0 || exit
